...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-[#050506] text-white selection:bg-(--color-accent) selection:text-black">
      {/* Background Decorativo */}
      <div className="fixed inset-0 z-0 overflow-hidden pointer-events-none">
        <div className="absolute top-[-10%] left-[-10%] w-[40%] h-[40%] rounded-full bg-(--color-accent)/5 blur-[120px]" />
        <div className="absolute bottom-[-10%] right-[-10%] w-[40%] h-[40%] rounded-full bg-(--color-accent)/5 blur-[120px]" />
      </div>
      ...
      <header className="fixed top-0 z-50 w-full border-b border-white/5 bg-[#050506]/80 backdrop-blur-lg">
        <div className="mx-auto flex max-w-5xl items-center justify-between px-6 py-5 md:px-10">
          <a
            href="/"
            className="text-xl font-black tracking-tighter transition-all hover:text-(--color-accent)"
          >
          ...
          <nav className="hidden items-center gap-8 md:flex">
            {["Sobre", "Projetos", "Stacks", "Contato"].map((item) => (
              <a
                ...
                className="relative text-[10px] font-bold uppercase tracking-widest text-white/40 transition-all hover:text-white after:absolute after:bottom-[-4px] after:left-0 after:h-[2px] after:w-0 after:bg-(--color-accent) after:transition-all hover:after:w-full"
              >
                {item}
              </a>
            ))}
      ...
      <main className="relative z-10 mx-auto flex max-w-5xl flex-col gap-16 px-6 pb-20 pt-32 md:flex-row md:items-start md:px-10 md:pt-48">
        ...
        <section className="flex-1 space-y-12">
          <div className="space-y-6">
            <div className="inline-flex items-center gap-3 rounded-full border border-white/5 bg-white/5 px-4 py-1.5 backdrop-blur-sm">
              <span className="relative flex h-2 w-2">
                ...
                <span className="relative inline-flex h-2 w-2 rounded-full bg-(--color-accent)"></span>
              </span>
            ...
            <h1 className="text-6xl font-black leading-[0.95] tracking-tighter sm:text-7xl md:text-8xl">
              Gabriel <br />
              <span className="text-(--color-accent)">Neves</span>
            </h1>
          ...
          <div className="flex flex-wrap items-center gap-6 pt-4">
            <a
              href="#projetos"
              className="group relative flex items-center justify-center overflow-hidden rounded-full bg-white/10 px-10 py-5 text-[10px] font-bold uppercase tracking-widest text-white transition-all hover:scale-105 active:scale-95 border border-white/5 hover:border-(--color-accent)/30"
            >
              <span className="relative z-10">Ver Projetos</span>
              <div className="absolute inset-0 -translate-x-full bg-(--color-accent) transition-transform duration-300 group-hover:translate-x-0"></div>
            </a>
            <a
        ...
        <section className="relative mt-10 flex flex-1 justify-center md:mt-0 md:justify-end">
          <div className="group relative h-96 w-72 md:h-[450px] md:w-80">
            ...
            <div className="relative h-full w-full overflow-hidden rounded-[3rem] border border-white/5 bg-[#111112] transition-all duration-700 group-hover:border-(--color-accent)/30">
              ...
              />
              <div className="absolute inset-0 bg-linear-to-t from-black via-transparent to-transparent opacity-80 transition-all duration-700 group-hover:opacity-40" />
      ...
      >
        <div className="grid gap-12 rounded-[3rem] border border-white/5 bg-white/2 p-12 backdrop-blur-sm md:grid-cols-[1.2fr_0.8fr]">
          <div className="space-y-6">
            <p className="text-[10px] font-black uppercase tracking-[0.3em] text-(--color-accent)">Sobre mim</p>
      ...
      >
        <div className="mb-12 flex items-end justify-between">
          <div className="space-y-4">
            <p className="text-[10px] font-black uppercase tracking-[0.3em] text-(--color-accent)">Portfólio</p>
        ...
        <div className="mx-auto max-w-5xl px-6 md:px-10">
          <div className="flex flex-col items-center justify-between gap-10 md:flex-row">
            ...
            <div className="flex flex-wrap justify-center gap-6">
              <a
                href="mailto:bielnevesferrer@gmail.com"
                className="group flex flex-col items-center gap-2 rounded-2xl border border-white/5 bg-white/5 p-4 transition-all hover:border-(--color-accent)/30 hover:bg-white/10"
              >
                <span className="text-[10px] font-black uppercase tracking-widest text-white/40 group-hover:text-(--color-accent)">E-mail</span>
              ...
              <a
                ...
                className="group flex flex-col items-center gap-2 rounded-2xl border border-white/5 bg-white/5 p-4 transition-all hover:border-(--color-accent)/30 hover:bg-white/10"
              >
                <span className="text-[10px] font-black uppercase tracking-widest text-white/40 group-hover:text-(--color-accent)">GitHub</span>
              ...
              <a
                ...
                className="group flex flex-col items-center gap-2 rounded-2xl border border-white/5 bg-white/5 p-4 transition-all hover:border-(--color-accent)/30 hover:bg-white/10"
              >
                <span className="text-[10px] font-black uppercase tracking-widest text-white/40 group-hover:text-(--color-accent)">LinkedIn</span>
